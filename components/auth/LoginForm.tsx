    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-heading">{t('nav.login')}</CardTitle>
        ...
        <CardContent>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            {t('nav.signup')}? <Link href="/signup" className="text-primary hover:underline cursor-pointer">{t('nav.signup')}</Link>
          </p>
        </CardContent>
      </Card>
    </div>
